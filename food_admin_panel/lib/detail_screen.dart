                              ...
                              Expanded(
                                child: Container(
                                  decoration: BoxDecoration(
                                      ...
                                      border:
                                          Border.all(color: const Color.fromARGB(255, 192, 127, 127))),
                                  padding:
                              ...
                              Expanded(
                                child: Container(
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                                      border:
                                          Border.all(color: const Color.fromARGB(255, 198, 139, 139))),
                                  padding:
                                      const EdgeInsets.symmetric(vertical: 16),
                                  child: Column(
                                    children: <Widget>[
                              ...
                              Expanded(
                                child: Container(
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                                      border:
                                          Border.all(color: const Color.fromARGB(255, 196, 156, 156))),
                                  padding:
                                      const EdgeInsets.symmetric(vertical: 16),
                                  child: Column(
                                    children: <Widget>[
